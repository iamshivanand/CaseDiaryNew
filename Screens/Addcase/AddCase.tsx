...
const fieldGroups = [
  {
    ...
    icon: "person-outline",
    fields: ["CaseTitle", "CNRNumber", "case_number", "crime_number", "crime_year", "Undersection", "ClientName", "ClientContactNumber", "case_type_id", "court_id", "district_id", "police_station_id"]
  },
  {
