...
export const getEditCaseScreenStyles = (theme: Theme) => StyleSheet.create({
  screen: {
    flex: 1,
    backgroundColor: theme.colors.screenBackground || theme.colors.background, // Use a specific screenBg or fallback
  },
  scrollContainer: { // This style is for the ScrollView component itself
    flexGrow: 1,
  },
  ...
  centeredMessageContainer: { // For centering "No documents/timeline" text or loader
