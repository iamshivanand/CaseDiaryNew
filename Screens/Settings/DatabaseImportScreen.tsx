...
const DatabaseImportScreen: React.FC = () => {
  ...
  const [previewData, setPreviewData] = useState<BackupPreviewData | null>(
    null
  );
  ...
  const verifyAndLoadBackup = async (
    fileUri: string,
    fileName: string,
    password?: string
  ) => {
  ...
  const handleReplace = async () => {
    ...
    Alert.alert(
      ...
      [
        ...
        {
          text:
            locale === "en" ? "Replace and Restart" : "बदलें और पुनरारंभ करें",
          style: "destructive",
          onPress: async () => {
            try {
              setIsLoading(true);
              ...
              Alert.alert(
                ...
                error.message ||
                  (locale === "en"
                    ...
                    : "बैकअप पुनर्प्राप्त करने में विफल।")
              );
            }
          },
        },
        ...
        {!selectedFileUri ? (
          <View style={styles.pickStage}>
            ...
            >
              ...
              <Text style={styles.uploadCardSubtext}>
                {locale === "en"
                  ? "Supports .db or .sqlite files"
                  : ".db या .sqlite फ़ाइलों का समर्थन करता है"}
              </Text>
            </TouchableOpacity>
          </View>
        ) : (
          <View style={styles.previewStage}>
                ...
                <Text style={styles.fileCardStatus}>
                  {dbPassword
                    ? locale === "en"
                      ...
                      : "सफलतापूर्वक डिक्रिप्ट किया गया"
                    : locale === "en"
                      ? "Ready to Restore"
            ...
            <View style={styles.statsRow}>
              <LinearGradient
                colors={
                  theme.dark ? ["#1E293B", "#0F172A"] : ["#E0F2FE", "#BAE6FD"]
                }
              ...
              >
                ...
                <Text style={styles.statsValue}>
                  {previewData?.caseCount ?? 0}
                </Text>
                <Text style={styles.statsLabel}>
                  {locale === "en" ? "Total Cases" : "कुल मामले"}
                </Text>
              </LinearGradient>

              <LinearGradient
                colors={
                  theme.dark ? ["#1E293B", "#0F172A"] : ["#ECFDF5", "#D1FAE5"]
                }
                style={styles.statsCard}
              >
                <Ionicons
                ...
                <Text style={styles.statsLabel}>
                  {locale === "en" ? "Hearings / Events" : "सुनवाई / घटनाएँ"}
                </Text>
              </LinearGradient>
            </View>
            ...
            {previewData && previewData.previewCases.length > 0 && (
              <View style={styles.casesPreviewCard}>
                <Text style={styles.cardHeaderTitle}>
                  {locale === "en"
                    ? "Backup Cases Preview"
                    : "बैकअप मामलों का पूर्वावलोकन"}
                </Text>
            ...
            <View style={styles.btnGroup}>
              <ActionButton
                title={
                  locale === "en" ? "Merge / Append Data" : "डेटा मर्ज / जोड़ें"
                }
                onPress={handleMerge}
                type="primary"
              />
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TextInput
              ...
              placeholder={
                locale === "en" ? "Enter Password Key" : "पासवर्ड दर्ज करें"
              }
