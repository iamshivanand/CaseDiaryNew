...
const StatusBadge: React.FC<StatusBadgeProps> = ({ status }) => {
  ...
  const getTranslatedStatus = (st: string | null | undefined) => {
    ...
    switch (clean) {
      case "open":
        return t("option_status_open");
      case "inprogress":
        return t("option_status_in_progress");
      case "closed":
        return t("option_status_closed");
      case "onhold":
        return t("option_status_on_hold");
      case "appealed":
        return t("option_status_appealed");
      default:
        return st;
    }
  };
