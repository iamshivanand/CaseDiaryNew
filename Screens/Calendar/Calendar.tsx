...
const CalendarScreen: React.FC<Props> = () => {
  ...
  const [filter, setFilter] = useState<"All" | "High" | "Active" | "Pending">(
    "All"
  );
    ...
    return (
      ...
      >
        ...
        {dayMarking && (
          ...
          >
            <Text style={styles.eventBubbleText}>{dayMarking.eventsCount}</Text>
          </View>
        )}
      </TouchableOpacity>
    );
    ...
    >
      ...
      >
        ...
        <View style={styles.CardsContainer}>
          ...
          <Text
            style={[
              styles.agendaCountText,
              { color: theme.colors.textSecondary },
            ]}
          >
            {displayedCases.length}{" "}
            {displayedCases.length === 1
              ? t("cal_hearing_scheduled")
              : t("cal_hearings_scheduled")}
          </Text>
