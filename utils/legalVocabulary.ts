...
export const LEGAL_VOCABULARY: VocabularyEntry[] = [
  ...
  },
  {
    ...
    meaning:
      "A formal written statement of case presented by a plaintiff to initiate a civil suit.",
  },
  {
    ...
    meaning:
      "The defendant's formal written reply to the allegations raised in the plaintiff's plaint.",
  },
  {
    english: "Petitioner",
    hindi: "याचिकाकर्ता",
  ...
  },
  {
    ...
    meaning:
      "A formal notice to a court requesting that no action be taken without hearing the caveator first.",
  },
  {
    ...
    meaning:
      "An application made to the court to enforce a decree or judgment passed.",
  },
  {
  ...
  },
  {
    ...
    meaning:
      "A document by which an advocate is authorized to represent a litigant in court.",
  },
  {
    english: "Exemption",
    hindi: "छूट याचिका",
  ...
  },
  {
    ...
    meaning:
      "The temporary release of an accused person awaiting trial, sometimes on condition that a sum of money or security is lodged.",
  },
  {
    english: "Cognizable",
    hindi: "संज्ञेय",
    ...
    meaning:
      "An offense for which a police officer has the authority to make an arrest without a warrant.",
  },
  {
    ...
    meaning:
      "Offenses where the parties can compromise or settle instead of continuing trial.",
  },
  {
    english: "Decree",
  ...
  },
  {
    ...
    meaning:
      "Proceedings conducted for the benefit of, or on application of, only one party without notice to the other.",
  },
  {
    ...
    meaning:
      "The official authority of a court to administer justice or hear a case within defined limits.",
  },
];
