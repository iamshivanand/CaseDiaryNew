...
const getFirstSyncInternal = (currentDbName, sql, params = []) => {
...
const getAllSyncInternal = (currentDbName, sql, params = []) => {
        ...
        return {
          executeSync: jest.fn((params = []) => {
            ...
            return {
              ...
              getAllSync: () => getAllSyncInternal(currentDbName, sql, params),
              getFirstSync: () => getFirstSyncInternal(currentDbName, sql, params),
            };
          }),
